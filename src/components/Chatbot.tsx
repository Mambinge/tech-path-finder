            ...
            <div className="flex items-center justify-between border-b border-border bg-gradient-to-r from-primary/10 to-accent/10 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Ask me anything about tech careers! 🚀</p>
                </div>
              </div>
              <Button
                variant="ghost"
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground mb-4">
                      Hi! 👋 I'm here to help you explore tech careers in Zimbabwe. Ask me anything!
                    </p>
                  </div>
