      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            Made with <Heart className="w-4 h-4 text-security fill-current" /> for A-Level graduates
          </div>
        ...
        <div className="border-t border-muted-foreground/20 mt-8 pt-8 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} TechPath ZW. Helping Zimbabwean students find their tech career path.
        </div>
      </div>
    </footer>
  );
